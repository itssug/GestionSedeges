...
<main class="container mt-4">
  <div class="card shadow rounded-4 border-0">
    <div class="card-header bg-gradient-teal text-white">
      <h4 class="mb-0 fw-semibold">Editar Trámite: {{ $tramite->nombre }}</h4>
    </div>
    ...
    <div class="card-body">
      ...
      <form action="{{ route('tramites.update', $tramite->id) }}" method="POST" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            >
              ...
              <option value="legal" {{ old('tipo', $tramite->tipo) == 'legal' ? 'selected' : '' }}>Legal</option>
              <option value="administrativo" {{ old('tipo', $tramite->tipo) == 'administrativo' ? 'selected' : '' }}>Administrativo</option>
              <option value="judicial" {{ old('tipo', $tramite->tipo) == 'judicial' ? 'selected' : '' }}>Judicial</option>
               <option value="medico" {{ old('tipo', $tramite->tipo) == 'medico' ? 'selected' : '' }}>Medico</option>
            </select>
            <div class="valid-feedback">¡Correcto!</div>
            @error('tipo')
              <div class="invalid-feedback">{{ $message }}</div>
           ...
           <div class="col-md-6">
            ...
            <input
              ...
              id="institucion"
              name="institucion"
              value="{{ old('institucion', $tramite->institucion) }}"
          ...
          <div class="col-12">
            ...
            <textarea
              ...
              required
            >{{ old('descripcion', $tramite->descripcion) }}</textarea>
            <div class="valid-feedback">¡Correcto!</div>
            @error('descripcion')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="col-md-6">
            ...
            <div class="form-check">
              <input
                ...
                id="estado_activo"
                value="1"
                {{ old('estado', $tramite->estado) ? 'checked' : '' }}
                required
              >
            ...
            <div class="form-check">
              <input
                ...
                id="estado_inactivo"
                value="0"
                {{ old('estado', $tramite->estado) === 0 ? 'checked' : '' }}
              >
