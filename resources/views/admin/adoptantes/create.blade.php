    ...
    <main class="container mt-4">
        <div class="card shadow rounded-4 border-0">
            <div class="card-header bg-gradient-teal text-white">
                <h4 class="mb-0 fw-semibold">Registrar Nuevo Adoptante</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('adoptantes.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    <div class="row g-3">
                        {{-- Foto --}}
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="nivel_educativo" id="nivel_educativo" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" name="ingresos_mensuales" id="ingresos_mensuales" min="0" required>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
            ...
            fechaInput.addEventListener('change', () => {
                ...
                limiteEdad.setFullYear(hoy.getFullYear() - 20); // mínimo 10 años
